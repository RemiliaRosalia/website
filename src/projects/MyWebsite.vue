...
<div class="projectPage">
    ...
    <div class="projectIMG">
      <h5>Tools used: Visual Studio, HTML, Vue.JS</h5>
    </div>
    <div>
      <p>
        This website has been a long project of mine to not only develop my webdesign and programming skills but to also have a place to show off my work.
